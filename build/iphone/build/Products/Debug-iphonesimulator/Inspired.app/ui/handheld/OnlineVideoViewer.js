...
// 'iFWpE60dZgU' Giant's Causeway NI
//'6bFuxQwfG28' Phil Coulter Danny Boy
//

function OnlineVideoViewerWindow(title){

    var onlinevideoViewerWindow = Ti.UI.createWindow({
		barColor: Ti.App.Properties.getString('appbuttoncolor'), //dark green
		backgroundColor:Ti.App.Properties.getString('appbkgrdcolor')
	});
	
	onlinevideoViewerWindow.addEventListener('open', function() {
		...
		newplayMovie('YouTube Movie Player', 'iFWpE60dZgU');
	});
...
var xhr = Ti.Network.createHTTPClient();
	...
	onlinevideoViewerWindow.titleControl = header;
	onlinevideoViewerWindow.add(subheader);
	onlinevideoViewerWindow.add(detailview);
...
// Set the window orientation
            onlinevideoViewerWindow.orientationModes = [Ti.UI.LANDSCAPE_RIGHT];
    ...
    btnBack.addEventListener('click',function(e){
  		onlinevideoViewerWindow.remove(playersubheader);
	...
	onlinevideoViewerWindow.add(playersubheader);
...
{// show a 'loading' spinning wheel
	...
	onlinevideoViewerWindow.setToolbar([toolActInd], {animated:true});
	toolActInd.show();
...
//the video will be played using the function we defined earlier
	...
	onlinevideoViewerWindow.setToolbar(null, {animated:true});
	}
	...
	onlinevideoViewerWindow.addEventListener('youGotFocus', function(e){
...
function GetDateTime() {
	...
	return onlinevideoViewerWindow;

};
module.exports = OnlineVideoViewerWindow;