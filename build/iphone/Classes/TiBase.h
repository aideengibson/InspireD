...
// in simulator we redefine to format for Inspired Developer console
...
{\
	NSString * exceptionName = [@"org.inspired." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.inspired";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIInspiredNativeItemNone = -1, 
	UIInspiredNativeItemSpinner = -2,
	UIInspiredNativeItemProgressBar = -3,
	
	UIInspiredNativeItemSlider = -4,
	UIInspiredNativeItemSwitch = -5,
	UIInspiredNativeItemMultiButton = -6,
	UIInspiredNativeItemSegmented = -7,
	
	UIInspiredNativeItemTextView = -8,
	UIInspiredNativeItemTextField = -9,
	UIInspiredNativeItemSearchBar = -10,
	
	UIInspiredNativeItemPicker = -11,
	UIInspiredNativeItemDatePicker = -12,
	
	UIInspiredNativeItemInfoLight = -13,
	UIInspiredNativeItemInfoDark = -14,
	
	UIInspiredNativeItemDisclosure = -15,
	
	UIInspiredNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all Inspired instances of
