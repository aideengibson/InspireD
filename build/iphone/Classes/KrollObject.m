...
//@interface InspiredObject : NSObject
//@end

@interface InspiredObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[InspiredObject class]])
		{
			for (NSString *key in [[(InspiredObject*)o modules] allKeys])
			{
